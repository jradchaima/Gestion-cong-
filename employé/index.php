...
<html lang="en">
  <head>
  	<title>Profil de l'employée</title>
    <meta charset="utf-8">
...
<ul class="list-unstyled components mb-5">
	          ...
	          <li>
              <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Congé</a>
              <ul class="collapse list-unstyled" id="pageSubmenu">
                <li>
                    <a href="demander_conge.php">Demander un congé</a>
                </li>
                <li>
                    <a href="historiquedemandec.php">Historique des demandes</a>
                </li>
              </ul>
	          </li>
	          <li>
              <a href="changer-motdepassec.php">Changer mot de passe</a>
	          </li>
	          <li>
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item dropdown">
            ...
            $vu=2;
                ...
                { 
                ?>
              <a  href="historiquedemandec.php?leaveid=<?php echo htmlentities($result->lid)?>"class="dropdown-item " >  Voir la décision <br>du demande <br>au date:<br><?php echo htmlentities($result->datedemande)?> <br><?php echo htmlentities($result->first_name)?><br><?php echo htmlentities($result->last_name)?> </a>
